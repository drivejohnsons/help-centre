<template>
    <div class="relative">
        <div class="relative z-20">
            <input aria-label="Search" type="text" name="query" placeholder="Search our help articles..." class="w-full rounded-md shadow bg-white placeholder-gray-400 text-base px-4 py-3 pr-14 outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-1 transition duration-150 ease-in-out dark:bg-gray-700 ring-offset-transparent focus:outline-none dark:text-white" id="searchTerm" @input="e => search(e.target.value)">
