        ...
        <div class="max-w-7xl px-8 mx-auto">
            <div class="md:flex md:items-center md:space-x-16">
                <div class="w-32 h-32 md:w-40 md:h-40 rounded-md overflow-hidden relative">
                    <picture>
                        <source srcset="{{ HelpCentre::learnersIcon('webp') }}" type="image/webp">
                        <source srcset="{{ HelpCentre::learnersIcon('jpg') }}" type="image/jpeg">
                        <img src="{{ HelpCentre::learnersIcon('jpg') }}" alt="driveJohnson's Learners Icon" class="min-w-full min-h-full object-cover object-center" width="160" height="160">
                    </picture>
                </div>
