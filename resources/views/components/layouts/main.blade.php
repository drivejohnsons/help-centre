    ...
    <div class="min-h-screen bg-white dark:bg-gray-900" id="app">
        ...
        <div class="fixed top-20 bg-gray-100 inset-x-0 z-50 py-5 px-8 shadow-sm" v-if="menuOpen">
            ...
            <form method="GET" action="{{ secure_url('search') }}" class="block mt-5">
                <div class="relative">
                    <input aria-label="Search" type="text" name="query" placeholder="Search our help articles..." class="w-full rounded-md shadow bg-white placeholder-gray-400 text-base px-4 py-3 pr-14 outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-1 transition duration-150 ease-in-out dark:bg-gray-700 ring-offset-transparent focus:outline-none dark:text-white" id="searchTerm">
